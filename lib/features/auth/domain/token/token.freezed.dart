...
class _$TokenImpl implements _Token {
  _$TokenImpl(@JsonKey(name: 'token') this.token,
...
abstract class _Token implements Token {
  factory _Token(@JsonKey(name: 'token') final String? token,
      @JsonKey(name: 'refreshToken') final String? refreshToken) = _$TokenImpl;
